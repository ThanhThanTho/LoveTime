...
public class MainActivity extends AppCompatActivity {
    ...
    private boolean onNavigationItemSelected(MenuItem item) {
        ...
        else if(item.getItemId() == R.id.nav_rela){
            Toast.makeText(this,"Chức năng đang trong giai đoạn phát triển",Toast.LENGTH_SHORT).show();
        }
        else if(item.getItemId() == R.id.nav_memory){
            Intent i = new Intent(this, MemoriesActivity.class);
            String previewString = firstPersonName.getText()+" & "+secondPersonName.getText();
            i.putExtra("previewString", previewString);
            i.putExtra("currentRelaName", relaName.getText().toString());
